...
bucket = storage_client.bucket("kgmlops")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "gcpmlops-441216.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://kgmlops/bank_campaign_data/bank-campaign-training-data.csv"
    model_name = 'xgboost'
